 <?php
    ...
    if ($stmt->prepare("select *,'false' as isInFilter
    ...
    if ($stmt2->prepare("select *,'false' as isInFilter from i_dictionary.item_dictionary where field_name = ? or object_name = ? and item_type_code = 'HPC.Item.Relationship'")){
        $temparray2 = array();
